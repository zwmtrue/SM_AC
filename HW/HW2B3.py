# -*- coding: utf-8 -*-
"""
Created on Sun Jun 05 23:50:55 2016
...
pylab.title(' Event-driven Molecular dynamics algorithm histogram (density eta=0.18)')
pylab.grid()
pylab.savefig('event_disks_box_histo.png')
pylab.show()